{ =====================================================================
FET430P440 TARGET ENVIRONMENT CONFIGURATION

Copyright 2001  FORTH, Inc.

The target environment is configured here for the MSP-FET430P440
as shipped with the MSP430F449.
...
0300 09FF UDATA SECTION URAM            \ Uninitialized data
