{ =====================================================================
FET430P140/F135 TARGET ENVIRONMENT CONFIGURATION

Copyright 2001  FORTH, Inc.

The target environment is configured here for the MSP-FET430P140
with the MSP430F135 instead of the default F149 part.
...
0210 03FF UDATA SECTION URAM            \ Uninitialized data
C000 FFFF CDATA SECTION PROG            \ Main program in flash memory

|NUM| 16 + RESERVE EQU 'H0              \ Target dictionary
