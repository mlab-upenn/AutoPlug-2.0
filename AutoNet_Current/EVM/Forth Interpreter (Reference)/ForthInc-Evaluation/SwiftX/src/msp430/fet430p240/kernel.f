...
INCLUDE %SWIFTX\SRC\MSP430\REG_241X             \ MSP430x241x hardware equates
...
TARGET-INTERP [IF]
INCLUDE %SWIFTX\SRC\MSP430\INTERP               \ Resident interpreter support
INCLUDE %SWIFTX\SRC\INTERP                      \ Resident interpreter
INCLUDE %SWIFTX\SRC\MEM                         \ Resident memory management
INCLUDE %SWIFTX\SRC\MSP430\COMP                 \ Resident compiler support
...
INCLUDE %SWIFTX\SRC\MSP430\FET430P240\START     \ Power-up initialization
