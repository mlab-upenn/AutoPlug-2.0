{ =====================================================================
eZ430 INITIALIZATION

Copyright 2008  FORTH, Inc.

This file supplies the power-up initialization code for the eZ430 as
...
LABEL POWER-UP
   ...
   0 # SR MOV                           \ Clear SR
   $20 # BCSCTL3 & MOV                  \ ACLK from VLOCLK
   'S0 # S MOV   0 # T MOV              \ Establish stack pointers
   'R0 # U MOV   U R MOV
   ' START # BR   END-CODE

CDATA  LIMITS DROP  EQU 0CODE           \ Starting code space address
   HERE 0CODE - EQU |CODE|              \ Size of code to download

HERE NEGATE $1FF AND ALLOT              \ Align to flash erase sector
