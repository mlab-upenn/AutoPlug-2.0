{ =====================================================================
Register and vector equates for MSP430x241x and MSP430x261x

Copyright 2009 by FORTH, Inc.
...
$0015 EQU P8REN                 \ Port P8 resistor enable
$003F EQU P8SEL                 \ Port P8 selection
$003D EQU P8DIR                 \ Port P8 direction
$003B EQU P8OUT                 \ Port P8 output
$0039 EQU P8IN                  \ Port P8 input

$0014 EQU P7REN                 \ Port P7 resistor enable
$003E EQU P7SEL                 \ Port P7 selection
$003C EQU P7DIR                 \ Port P7 direction
$003A EQU P7OUT                 \ Port P7 output
$0038 EQU P7IN                  \ Port P7 input
