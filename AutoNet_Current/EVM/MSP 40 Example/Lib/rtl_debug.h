...
extern uint16_t prev_offset;
extern uint16_t rtl_drift_rate;

extern uint8_t _tsync_index;
extern uint8_t _dbg_index; //fix
extern uint8_t pkt_log[MAX_PKT_LOG/8];
extern uint8_t tsync_log[MAX_TSYNC_LOG];
extern uint8_t tsync_delay[MAX_TSYNC_LOG];
