...
#define RTL_NRK_TICKS_PER_SLOT 36  //fix srinivas	
...
#define RTL_SLOT_TIME_US   (US_PER_TICK*(RTL_NRK_TICKS_PER_SLOT))  //fix srinivas 
...
#define TX_GUARD_TIME   4000          //4000    //fix srinivas
...
#define SFD_TO_NEXT_SLOT_TIME     (29050)        //(27750)  //fix srinivas
