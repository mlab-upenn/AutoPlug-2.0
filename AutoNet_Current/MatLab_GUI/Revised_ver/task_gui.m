...
% Last Modified by GUIDE v2.5 22-Mar-2011 16:52:19
...
handles.s = s;
handles.s.BytesAvailableFcnCount = 5;
...
choice=get(hObject,'Value');
    switch choice
        ...
        case 3
            handles.ECUs(handles.No_of_ECUs).action(1)= bitand(uint8(handles.ECUs(handles.No_of_ECUs).action(1)), uint8(bin2dec('00001111')));
            handles.ECUs(handles.No_of_ECUs).action(1)= bitor(uint8(handles.ECUs(handles.No_of_ECUs).action(1)), uint8(bin2dec('00110000')));   
    end
...
choice=get(hObject,'Value');
    switch choice
        ...
        case 3
            handles.ECUs(handles.No_of_ECUs).action(1)= bitand(uint8(handles.ECUs(handles.No_of_ECUs).action(1)), uint8(bin2dec('11110000')));
            handles.ECUs(handles.No_of_ECUs).action(1)= bitor(uint8(handles.ECUs(handles.No_of_ECUs).action(1)), uint8(bin2dec('00000011')));
    end
...
choice=get(hObject,'Value');
    switch choice
        ...
        case 3
            handles.ECUs(handles.No_of_ECUs).action(2)= bitand(uint8(handles.ECUs(handles.No_of_ECUs).action(2)), uint8(bin2dec('00001111')));
            handles.ECUs(handles.No_of_ECUs).action(2)= bitor(uint8(handles.ECUs(handles.No_of_ECUs).action(2)), uint8(bin2dec('00110000')));
    end
...
choice=get(hObject,'Value');
    switch choice
        ...
        case 3
            handles.ECUs(handles.No_of_ECUs).action(2)= bitand(uint8(handles.ECUs(handles.No_of_ECUs).action(2)), uint8(bin2dec('11110000')));
            handles.ECUs(handles.No_of_ECUs).action(2)= bitor(uint8(handles.ECUs(handles.No_of_ECUs).action(2)), uint8(bin2dec('00000011')));
    end
...
choice=get(hObject,'Value');
    switch choice
        ...
        case 3
            handles.ECUs(handles.No_of_ECUs).action(3)= bitand(uint8(handles.ECUs(handles.No_of_ECUs).action(3)), uint8(bin2dec('00001111')));
            handles.ECUs(handles.No_of_ECUs).action(3)= bitor(uint8(handles.ECUs(handles.No_of_ECUs).action(3)), uint8(bin2dec('00110000')));
    end
...
choice=get(hObject,'Value');
    switch choice
        ...
        case 3
            handles.ECUs(handles.No_of_ECUs).action(3)= bitand(uint8(handles.ECUs(handles.No_of_ECUs).action(3)), uint8(bin2dec('11110000')));
            handles.ECUs(handles.No_of_ECUs).action(3)= bitor(uint8(handles.ECUs(handles.No_of_ECUs).action(3)), uint8(bin2dec('00000011')));
    end
...
choice=get(hObject,'Value');
    switch choice
        ...
        case 3
            handles.ECUs(handles.No_of_ECUs).action(4)= bitand(uint8(handles.ECUs(handles.No_of_ECUs).action(4)), uint8(bin2dec('00001111')));
            handles.ECUs(handles.No_of_ECUs).action(4)= bitor(uint8(handles.ECUs(handles.No_of_ECUs).action(4)), uint8(bin2dec('00110000')));
    end
...
switch choice
        ...
        case 3
            handles.ECUs(handles.No_of_ECUs).action(4)= bitand(uint8(handles.ECUs(handles.No_of_ECUs).action(4)), uint8(bin2dec('11110000')));
            handles.ECUs(handles.No_of_ECUs).action(4)= bitor(uint8(handles.ECUs(handles.No_of_ECUs).action(4)), uint8(bin2dec('00000011')));
 end
...
read_values = fread(handles.s, 5, 'uint8');
if(read_values(1)==uint8(85) )
    if(read_values(2)==uint8(204))
        checksum = bitxor(uint8(85),uint8(204));
        for i=3:4
        checksum = bitxor(checksum,uint8(read_values(i)));
        
        end
        
        if(read_values(5)==checksum)
            set(handles.ecu_status_msg, 'String', 'Error Report');
